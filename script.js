  ...
  todoPosts.forEach((post, index) => {
    ...
    postsHTML += `
          <div class="post">
              ...
              <div class="priority" style="color: ${priorityColor};">Priority: ${post.priority}</div>
...
function initApp() {
  ...
  document
    ...
    .addEventListener("click", openTodoPage);
  document
    .getElementById("save-todo-button")
    .addEventListener("click", saveTodo);
  document
    .getElementById("delete-posts-button")
